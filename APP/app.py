...
function applyEssenceColors() {{
    ...
    const colorRules = [
        {{ keywords: ['sangre', 'cereza', 'frambuesa', 'pimienta rosa', 'rosa', 'ruibarbo', 'lichi', 'ciruela', 'grosella'], bg: 'rgba(180, 150, 160, 0.15)', border: 'rgba(180, 150, 160, 0.4)' }},
        {{ keywords: ['marina', 'marinas', 'agua', 'océano', 'menta'], bg: 'rgba(150, 170, 180, 0.15)', border: 'rgba(150, 170, 180, 0.4)' }},
        {{ keywords: ['albahaca', 'bergamota', 'cardamomo', 'higo', 'manzana', 'pachulí', 'pera', 'romero', 'salvia', 'té verde', 'vetiver'], bg: 'rgba(160, 170, 150, 0.15)', border: 'rgba(160, 170, 150, 0.4)' }},
        {{ keywords: ['azafrán', 'ámbar', 'mandarina', 'melocotón', 'mirra', 'naranjo', 'pomelo', 'cítrico', 'limón', 'piña'], bg: 'rgba(190, 170, 140, 0.15)', border: 'rgba(190, 170, 140, 0.4)' }},
        {{ keywords: ['caramelo', 'miel', 'solares', 'vainilla', 'ylang', 'cacao', 'café', 'canela', 'tonka', 'nuez moscada', 'praliné'], bg: 'rgba(170, 150, 140, 0.15)', border: 'rgba(170, 150, 140, 0.4)' }},
        {{ keywords: ['iris', 'lavanda', 'jazmín', 'nardos', 'neroli'], bg: 'rgba(160, 150, 170, 0.15)', border: 'rgba(160, 150, 170, 0.4)' }},
        {{ keywords: ['cedro', 'sándalo', 'tabaco', 'abedul', 'cuero', 'oud', 'ámbar gris', 'incienso'], bg: 'rgba(130, 130, 130, 0.15)', border: 'rgba(130, 130, 130, 0.4)' }},
        {{ keywords: ['almizcle', 'coco', 'civeta', 'pimienta blanca', 'pimienta negra'], bg: 'rgba(180, 180, 180, 0.1)', border: 'rgba(180, 180, 180, 0.3)' }}
    ];
