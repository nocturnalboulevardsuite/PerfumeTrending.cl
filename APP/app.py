...
# Posicionamiento del Switch de Tema (+10% de tamaño)
bottle_left_pos = "40px" if is_dark else "-2px"
static_icon_pos = "11px center" if is_dark else "calc(100% - 11px) center"
...
# 3. CSS ULTRA MINIMALISTA Y COMPACTO
st.markdown(f"""
    <style>
    ...
    /* SWITCH DE TEMA REFINADO (+10% TAMAÑO) */
    .st-key-theme_toggle button {{
    ...
    .st-key-theme_toggle button::before {{
        ...
        width: 75px !important; height: 33px !important;
    ...
    .st-key-theme_toggle button::after {{
        ...
        width: 37px !important; height: 42px !important;
