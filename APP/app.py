...
# Colores generales (Ajustados para tema oscuro / claro)
app_bg_css = "background-color: #0e1117 !important;" if is_dark else "background-color: #f6efe9 !important;"
...
# 2. SCRIPT DE INYECCIÓN JAVASCRIPT CON COLORES MATE DIFERENCIADOS
js_color_script = f"""
<script>
function applyEssenceColors() {{
    ...
    const colorRules = [
        // Rojos / Frutos Rojos / Rosas (Borgoña Mate)
        {{ keywords: ['sangre', 'cereza', 'frambuesa', 'pimienta rosa', 'rosa', 'ruibarbo', 'lichi', 'ciruela', 'grosella'], bg: 'rgba(168, 50, 75, 0.25)', border: 'rgba(200, 70, 95, 0.6)' }},
        
        // Marinas / Acuáticas (Azul Océano Mate)
        {{ keywords: ['marina', 'marinas', 'agua', 'océano'], bg: 'rgba(20, 110, 140, 0.25)', border: 'rgba(40, 150, 180, 0.6)' }},
        
        // Verdes / Follaje / Frescos (Verde Bosque Mate)
        {{ keywords: ['albahaca', 'bergamota', 'cardamomo', 'higo', 'manzana', 'menta', 'pachulí', 'pera', 'romero', 'salvia', 'té verde', 'vetiver'], bg: 'rgba(35, 110, 60, 0.25)', border: 'rgba(50, 160, 85, 0.6)' }},
        
        // Cítricos / Ámbar / Cálidos (Terracota Mate)
        {{ keywords: ['azafrán', 'ámbar', 'mandarina', 'melocotón', 'mirra', 'naranjo', 'pomelo', 'cítrico', 'cítricos', 'limón', 'piña'], bg: 'rgba(180, 100, 30, 0.25)', border: 'rgba(210, 130, 50, 0.6)' }},
        
        // Dulces / Gourmet / Especias (Espresso / Tostado Mate)
        {{ keywords: ['caramelo', 'miel', 'solares', 'vainilla', 'ylang', 'cacao', 'café', 'canela', 'tonka', 'nuez moscada', 'praliné'], bg: 'rgba(110, 60, 40, 0.3)', border: 'rgba(160, 90, 60, 0.6)' }},
        
        // Florales Violeta / Lavanda (Violeta Plomizo Mate)
        {{ keywords: ['iris', 'lavanda', 'jazmín', 'nardos', 'neroli'], bg: 'rgba(110, 60, 150, 0.25)', border: 'rgba(150, 90, 190, 0.6)' }},
        
        // Maderas / Cuero / Ahumados (Gris Madero Ahumado)
        {{ keywords: ['cedro', 'sándalo', 'tabaco', 'abedul', 'cuero', 'oud', 'ámbar gris', 'incienso'], bg: 'rgba(80, 85, 95, 0.3)', border: 'rgba(130, 135, 145, 0.6)' }},
        
        // Almizcle / Limpios (Perla Neutro)
        {{ keywords: ['almizcle', 'coco', 'civeta', 'pimienta blanca', 'pimienta negra'], bg: isDark ? 'rgba(255, 255, 255, 0.1)' : 'rgba(0, 0, 0, 0.06)', border: isDark ? 'rgba(255, 255, 255, 0.3)' : 'rgba(0, 0, 0, 0.25)' }}
    ];
    ...
    esencias_dict = [
        {
            ...
            "color_border": "rgba(40, 150, 180, 0.6)", 
            "color_bg": "rgba(20, 110, 140, 0.25)", 
        ...
        },
        {
            ...
            "color_border": "rgba(180, 180, 180, 0.4)", 
            "color_bg": "rgba(160, 160, 160, 0.15)", 
        ...
        },
        {
            ...
            "color_border": "rgba(200, 70, 95, 0.6)", 
            "color_bg": "rgba(168, 50, 75, 0.25)", 
        ...
        {
            "title": "Café (Gourmand)", 
            "color_border": "rgba(160, 90, 60, 0.6)", 
            "color_bg": "rgba(110, 60, 40, 0.3)", 
